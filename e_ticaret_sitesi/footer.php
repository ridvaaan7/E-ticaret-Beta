		...
		<div class="row">
			<div class="col-md-4"><!--footer twitter widget-->
				<div class="title-widget-bg">
					<div class="title-widget">Twitter Güncellemesi</div>
				</div>
				<!--<ul class="tweets">
					<li>Check out this great #themeforest item for you
						...
						<a href="#" class="btn btn-default btn-follow"><i class="fa fa-twitter fa-2x"></i><div>Bizi Twitterdan Takip Edin!! </div></a>
					...
					<div class="col-md-4"><!--footer newsletter widget-->
						...
						<div class="newsletter">
							<p>
								Lorem Ipsum Nedir?
								Lorem Ipsum, dizgi ve baskı endüstrisinde kullanılan mıgır metinlerdir. Lorem Ipsum, adı bilinmeyen bir matbaacının bir hurufat numune kitabı oluşturmak üzere bir yazı galerisini alarak karıştırdığı 1500'lerden beri endüstri standardı sahte metinler olarak kullanılmıştır. Beşyüz yıl boyunca varlığını sürdürmekle kalmamış.
							</p>
							<form role="form">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-9">
						...
						<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author']; echo "  2019" ?> </div>
					...
					<div class="col-md-3"><!--footer Share-->
						<div class="followon">Beni Takip Edin</div>
						<div class="fsoc">
