...
<head>
  ...
  <title>Rıdvan YILDIZ Panel</title>
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>RIDVAN YILDIZ</span></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="urun.php"><i class="fa fa-list"></i> Ürünler</a></li>
                 <li><a href="banka.php"><i class="fa fa-list"></i> Bankalar </a></li>
                    <li><a href="yorum.php"><i class="fa fa-list"></i> Yorumlar</a></li>
